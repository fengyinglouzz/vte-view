<template>
    <div class="fillcontain">
        ...
        <el-col :span="14" :offset="4" class="form_container">
          <el-form :rules="querySystemOrgListFormrules" :model="querySystemOrgListForm"  ref="querySystemOrgListForm" label-width="150px">
            <el-col :span="12">
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <el-button v-if="scope.row.orgType==='hospital'" @click="adddEpartmentClick(scope.row)" size="small">添加科室</el-button>
              </template>
            </el-table-column>
          </el-table>
          ...
          <el-dialog title="科室" v-model="addDepartmentFormVisible" :close-on-click-modal="false">
            ...
            <el-col :span="24" v-if="show">
              ...
              <el-form-item label="科室类型"  prop="orgType">
                <el-select v-model="addDepartmentForm.orgType" clearable placeholder="请选择" style="width: 100%;" >
                  <el-option
